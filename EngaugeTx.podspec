#
#  Be sure to run `pod spec lint EngaugeTx.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Medullan Platform Solutions" => "mps@medullan.com" }
  # Or just: s.author    = "Sean Hoilett"
  # s.authors            = { "Sean Hoilett" => "sean@medullan.com" }
  # s.social_media_url   = "http://twitter.com/Sean Hoilett"
  ...
  s.exclude_files = "Classes/Exclude", "EngaugeTx/samples", "EngaugeTx/docs"
